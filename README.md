...
> **Current state: `v0.2.2`, a public test release.** There is a
...
`image: ghcr.io/digit4w/watchpile:0.2.2`. **You don't need to clone anything** —
the image already ships the web client inside.

**Two tags, and the choice is about upgrading:** `:0.2.2` is what you pin in a
